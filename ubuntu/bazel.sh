...
# approach, but am I now running a bunch of redundant setup? Investigate this.
...
# Do not install openjdk-19-jre-headless or any other JRE -- it may mess things up by setting JAVA_HOME
