...
sudo ${PKGMGR} install -y libyaml-devel
sudo ${PKGMGR} install -y zlib-devel
sudo ${PKGMGR} install -y autoconf
sudo ${PKGMGR} install -y bison
sudo ${PKGMGR} install -y gperf
sudo ${PKGMGR} install -y libffi-devel
sudo ${PKGMGR} install -y openssl-devel
sudo ${PKGMGR} install -y readline-devel
sudo ${PKGMGR} install -y ruby	# according to official ruby instructions
sudo ${PKGMGR} install -y ruby-devel	# or is it this? or both?
